...
--
-- Name: games; Type: TABLE; Schema: public; Owner: sebosuar
--
...
ALTER TABLE public.games OWNER TO sebosuar;

--
-- Name: games_game_id_seq; Type: SEQUENCE; Schema: public; Owner: sebosuar
--
...
ALTER SEQUENCE public.games_game_id_seq OWNER TO sebosuar;

--
-- Name: games_game_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: sebosuar
--
...
--
-- Name: teams; Type: TABLE; Schema: public; Owner: sebosuar
--
...
ALTER TABLE public.teams OWNER TO sebosuar;

--
-- Name: teams_team_id_seq; Type: SEQUENCE; Schema: public; Owner: sebosuar
--
...
ALTER SEQUENCE public.teams_team_id_seq OWNER TO sebosuar;

--
-- Name: teams_team_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: sebosuar
--
...
--
-- Name: games game_id; Type: DEFAULT; Schema: public; Owner: sebosuar
--
...
--
-- Name: teams team_id; Type: DEFAULT; Schema: public; Owner: sebosuar
--
...
--
-- Data for Name: games; Type: TABLE DATA; Schema: public; Owner: sebosuar
--
...
--
-- Data for Name: teams; Type: TABLE DATA; Schema: public; Owner: sebosuar
--
...
--
-- Name: games_game_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sebosuar
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sebosuar
--
...
--
-- Name: games games_pkey; Type: CONSTRAINT; Schema: public; Owner: sebosuar
--
...
--
-- Name: teams teams_name_key; Type: CONSTRAINT; Schema: public; Owner: sebosuar
--
...
--
-- Name: teams teams_pkey; Type: CONSTRAINT; Schema: public; Owner: sebosuar
--
...
--
-- Name: games games_opponent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: sebosuar
--
...
--
-- Name: games games_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: sebosuar
--
